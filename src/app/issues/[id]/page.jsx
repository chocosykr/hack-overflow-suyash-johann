    ...
    <div className="max-w-5xl mx-auto p-6 lg:p-10 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <span className={`flex items-center gap-1.5 text-[10px] font-bold px-3 py-1.5 rounded-full uppercase border ${
          ...
          <section className="space-y-6">
            ...
            <div className="relative border-l-2 border-gray-100 ml-4 pl-8 space-y-8 pb-4">
              <div className="relative">
                ...
                <div>
                  <p className="text-sm font-bold text-gray-900">Issue Logged</p>
                  <p className="text-xs text-gray-500 mt-1">Initial report submitted via mobile portal.</p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-gray-900">{issue.author?.name || "Anonymous Student"}</p>
                  <p className="text-xs text-gray-500 truncate w-32">{issue.author?.email}</p>
                </div>
              </div>
            </div>
          </div>
